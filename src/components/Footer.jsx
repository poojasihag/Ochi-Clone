...
const Footer = () => {
  return (
    <div   data-scroll data-scroll-speed=".10" className=" flex gap-5 w-full h-screen text-zinc-100 font-['Founders_Grotesk_X-Condensed'] bg-zinc-900 p-20">
      ...
      <div className="w-1/2">
        <h1 className="text-[8vw]  font-semibold upperCase leading-none -mb-10">
          Presentations
          <div className="details mt-10 font-['Neue_Montreal'] ">
